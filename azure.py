...
Requires an application in Azure to authenticate against.
    Requires the "User.Read" permission to get the user's profile.
    Needs to have a callback URL set, to match the one in config.yaml
